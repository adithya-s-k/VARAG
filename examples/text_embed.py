...
def gradio_interface():
    with gr.Blocks() as app:
        ...
        with gr.Tab("Upload PDF"):
            ...
            use_docling = gr.Checkbox(label="Use docling for PDF processing", value=False)
            process_button = gr.Button("Process PDF")
            pdf_output = gr.Textbox(label="Processing Status")
            
            process_button.click(process_pdf, inputs=[pdf_input, use_docling], outputs=pdf_output)
